...
df_sampled = pd.read_csv("25rows_with_embeddings_per_category.csv")
...
job_query = st.text_area("Enter Job Description", placeholder="e.g.,Machine Learning,Data Science ,SQL  & Have experience of 5 years")
